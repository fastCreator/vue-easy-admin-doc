var EcosystemNav = [
  {
    ...
    items: [
      {
        text: 'vue-easy-admin',
        link: 'https://github.com/PanJiaChen/vue-easy-admin'
      },
      {
      ...
      },
      {
        ...
        link: 'https://github.com/PanJiaChen/vue-easy-admin/issues/2312'
      },
      {
        text: 'vue-countTo',
  ...
  },
  {
    ...
    items: [
      ...
      },
      {
        text: 'Gitter',
        textZH: 'Gitter讨论组',
        link: 'https://gitter.im/vue-easy-admin/discuss'
      },
      {
        textZH: '作者Blog',
      ...
      {
        textZH: 'QQ群',
        link: 'https://github.com/PanJiaChen/vue-easy-admin/issues/602',
        type: 'ZH'
      },
      {
        textZH: '作者个人微博',
      ...
      },
      {
        ...
        textZH: '更新记录',
        link: 'https://github.com/PanJiaChen/vue-easy-admin/releases'
      }
    ]
  }
]
