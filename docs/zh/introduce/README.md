...
[![Build Status](https://travis-ci.org/PanJiaChen/vue-easy-admin.svg?branch=master)](https://travis-ci.org/PanJiaChen/vue-easy-admin)
[![license](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/PanJiaChen/vue-easy-admin/blob/master/LICENSE)
[![GitHub release](https://img.shields.io/github/release/PanJiaChen/vue-easy-admin.svg)](https://github.com/PanJiaChen/vue-easy-admin/releases)
[![donate](https://img.shields.io/badge/%24-donate-ff69b4.svg)](https://panjiachen.gitee.io/vue-easy-admin-doc/zh/donate)
[![GitHub stars](https://img.shields.io/github/stars/PanJiaChen/vue-easy-admin.svg?style=social&label=Stars)](https://github.com/PanJiaChen/vue-easy-admin)

<!-- <CodingAD /> -->

[vue-easy-admin](http://panjiachen.github.io/vue-easy-admin) 是一个后台前端解决方案，它基于 [vue](https://github.com/vuejs/vue) 和 [element-ui](https://github.com/ElemeFE/element)实现。它使用了最新的前端技术栈，内置了 i18 国际化解决方案，动态路由，权限验证，提炼了典型的业务模型，提供了丰富的功能组件，它可以帮助你快速搭建企业级中后台产品原型。相信不管你的需求是什么，本项目都能帮助到你。

:::tip 建议
本项目的定位是后台集成方案，不太适合当基础模板来进行二次开发。因为本项目集成了很多你可能用不到的功能，会造成不少的代码冗余。如果你的项目不关注这方面的问题，也可以直接基于它进行二次开发。

- 集成方案: [vue-easy-admin](https://github.com/PanJiaChen/vue-easy-admin)
...
- Others: [awesome-project](https://github.com/PanJiaChen/vue-easy-admin/issues/2312)
  :::
...
**本项目不支持低版本浏览器(如 ie)，有需求请自行添加 polyfill [详情](https://github.com/PanJiaChen/vue-easy-admin/wiki#babel-polyfill)**
...
```bash
# 克隆项目
git clone https://github.com/PanJiaChen/vue-easy-admin.git
...
Windows 用户若安装不成功，很大概率是`node-sass`安装失败，[解决方案](https://github.com/PanJiaChen/vue-easy-admin/issues/24)。
...
::: tip 建议
你可以把 `vue-easy-admin`当做工具箱或者集成方案仓库，在 `vue-admin-template` 的基础上进行二次开发，想要什么功能或者组件就去 `vue-easy-admin` 那里复制过来。
:::

## Contribution

本文档项目地址 [vue-easy-admin-doc](https://github.com/PanJiaChen/vue-easy-admin-doc) 基于 [vuepress](https://github.com/vuejs/vuepress)开发。

有任何修改和建议都可以该项目 pr 和 issue

[vue-easy-admin](https://github.com/PanJiaChen/vue-easy-admin) 还在持续迭代中，逐步沉淀和总结出更多功能和相应的实现代码，总结中后台产品模板/组件/业务场景的最佳实践。本项目也十分期待你的参与和[反馈](https://github.com/PanJiaChen/vue-easy-admin/issues)。
...
群主 **[圈子](https://jianshiapp.com/circles/1209)** 群主会经常分享一些技术相关的东西，或者加入 [qq 群](https://github.com/PanJiaChen/vue-easy-admin/issues/602) 或者关注 [微博](https://weibo.com/u/3423485724?is_all=1)。
